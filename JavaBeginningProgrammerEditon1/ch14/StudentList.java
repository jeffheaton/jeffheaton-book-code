 ...
 *
 * This class implements the student list, using objects.
 *
...
public class StudentList
{
  ...
  public static void bubbleSort(Student data[],
    int size)
  {
    boolean done = false;
    int index;
  ...
  public static void addStudent()
  {
    ...
    System.out.print(
      "Enter studentÕs type(i.e.  Freshman> ");
    String type = readInput();
    System.out.print("Enter studentÕs number> ");
    String n = readInput();
    ...
    {
      System.out.println(
        "You did not enter a valid student number.");
      return;
    }
  ...
  public static void deleteStudent()
  {
    ...
    {
      System.out.println(
        "There are no students yet, no one to "+
        "delete.");
      return;
    }
  ...
  // a simple method that inputs a line
